...
export const metaConfig: Record<string, MetaConfig> = {
  ...
  // Новые поступления
  '/new-arrivals': {
    title: 'Новые поступления автозапчастей - Protek',
    description: 'Свежие автозапчасти и аксессуары, недавно добавленные в ассортимент Protek. Следите за новыми поступлениями.',
    keywords: 'новые поступления, новинки, автозапчасти, protek',
    ogTitle: 'Новые поступления автозапчастей - Protek',
    ogDescription: 'Свежие товары и новинки, которые недавно появились в каталоге Protek.'
  },

  // Топ продаж
  '/top-sales': {
    title: 'Топ продаж автозапчастей - Protek',
    description: 'Самые популярные автозапчасти и аксессуары. Хиты продаж с лучшими отзывами покупателей Protek.',
    keywords: 'топ продаж, популярные автозапчасти, хиты продаж, protek',
    ogTitle: 'Топ продаж автозапчастей - Protek',
    ogDescription: 'Самые популярные автозапчасти и аксессуары с лучшими отзывами покупателей.'
  },

  // Лучшая цена
  '/best-price': {
    title: 'Лучшие цены на автозапчасти - Protek',
    description: 'Автозапчасти и аксессуары по лучшим ценам. Специальные предложения и скидки на качественные детали от Protek.',
    keywords: 'лучшие цены, скидки на автозапчасти, специальные предложения, protek',
    ogTitle: 'Лучшие цены на автозапчасти - Protek',
    ogDescription: 'Автозапчасти и аксессуары по специальным ценам со скидками от Protek.'
  },
  ...
  '/profile-req': {
    title: 'Реквизиты и юридические лица - Личный кабинет Protek',
    description: 'Управляйте юридическими лицами и банковскими реквизитами вашей компании в одном месте.',
    keywords: 'реквизиты, юридические лица, личный кабинет, данные компании',
    ogTitle: 'Реквизиты и юридические лица - Protek',
    ogDescription: 'Управляйте юридическими лицами и банковскими реквизитами вашей компании в одном месте.'
  },
  ...
  '/login-required': {
    title: 'Войдите, чтобы продолжить — Protek',
    description: 'Войдите или зарегистрируйтесь, чтобы добавлять авто в гараж, сохранять избранное и отслеживать заказы.',
    keywords: 'авторизация, вход, личный кабинет, избранное, гараж, заказы',
    ogTitle: 'Войдите, чтобы продолжить — Protek',
    ogDescription: 'Авторизация откроет доступ ко всем функциям: гараж, избранное, заказы.'
  },
