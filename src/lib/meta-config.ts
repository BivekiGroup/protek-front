...
export const metaConfig: Record<string, MetaConfig> = {
  ...
  '/login-required': {
    title: 'Требуется авторизация - Protek',
    description: 'Доступ к этой странице возможен только после авторизации.',
    keywords: 'требуется авторизация, войдите, доступ ограничен',
    ogTitle: 'Требуется авторизация - Protek',
    ogDescription: 'Нажмите «Вход», чтобы получить доступ к этой странице.'
  },
