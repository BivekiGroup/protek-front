...
const GuaranteeHelp = () => (
  <div className="div-block-11">
    <div className="w-layout-vflex flex-block-30">
      <h3 className="heading-6">Мы будем рады помочь вам с оформлением возврата товара!</h3>
      <div className="text-block-19">Если у вас возникли вопросы, пожалуйста, оставьте свой номер телефона. Наш менеджер свяжется с вами и поможет вернуть товар, или решить любой вопрос!</div>
    </div>
