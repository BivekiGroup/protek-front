...
const CartSummary: React.FC<CartSummaryProps> = ({ step, setStep }) => {
  ...
  if (!isAuthenticated) {
    const vat = summary.totalPrice * 0.2; // НДС 20%
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              {Math.round(summary.totalPrice).toLocaleString('ru-RU')} ₽
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              {Math.round(vat).toLocaleString('ru-RU')} ₽
            </div>
          </div>
